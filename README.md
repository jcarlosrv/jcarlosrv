...
**Data Scientist & ML Engineer** — full ML lifecycle delivery for enterprise and public-sector clients at [Quant16](https://quant16.com) (part of EKI Digital). Remote from Chihuahua, Mexico.

PhD in theoretical physics (quantum gravity). Peer-reviewed publications in *Physical Review D* and *Annals of Physics*. The combination trained me for the two things modern data work actually demands: mathematical rigor under uncertainty, and patience to extract clean signal from noisy data.
...
- [Effective dynamics of the Schwarzschild black hole interior with inverse triad corrections](https://doi.org/10.1016/j.aop.2021.168401) — *Annals of Physics*, 2021
